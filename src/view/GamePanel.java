...
//			grpOff.drawString(strDisplay, (d.width - fmt.stringWidth(strDisplay)) / 2, d.height/2);
        ...
        } else if (Commandcontrol.getInstance().isPaused()) {
...
//			}
    ...
    private void displayStartText() {
        ...
        strDisplay = "use the arrow keys to move the pieces and aline to score";
        grpOff.drawString(strDisplay,
                (Game.DIM.width - fmt.stringWidth(strDisplay)) / 2, Game.DIM.height / 4
                        + nFontHeight + 40);

        strDisplay = "use the space bar to rotate the piece and aline to score";
        grpOff.drawString(strDisplay,
                (Game.DIM.width - fmt.stringWidth(strDisplay)) / 2, Game.DIM.height / 4
                        + nFontHeight + 80);
    ...
    public GameJFrame getFrm() {
        return this.gmf;
    }

    public void setFrm(GameJFrame frm) {
        this.gmf = frm;
    }
