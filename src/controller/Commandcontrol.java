...
public class Commandcontrol {
    ...
    private long mHighScore;//  To indicate high score
    private int mThreshold;//To indicate the increasing speed of the falling pieces
    private long mScore;//To indicate your current Score
